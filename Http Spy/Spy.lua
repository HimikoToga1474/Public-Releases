...
if getgenv().CoolHttpSpy then
  return warn("HTTP(s) Spy already loaded. Run getgenv().CoolHttpSpy:Destroy() to destroy the thread.");
end;

local Serialize = loadstring(game:HttpGet("https://raw.githubusercontent.com/HimikoToga1474/Public-Releases/master/Http%20Spy/Serialize%20Highlighting.lua"))();
